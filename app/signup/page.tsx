"use client";
// app/signup/page.tsx
// Signup page. Calls FastAPI POST /auth/register.
// On success: auto logs in → saves token → redirects to /dashboard
...
export default function SignupPage() {
  ...
  try {
    ...
    // 1️⃣ Register user (this returns access_token and user)
    ...
    console.log("Registration success! User info:", registerData.user);

    // 2️⃣ Save token and user
  ...
  return (
    <div style={s.root}>
      {/* ── LEFT: GrowthOS Brand Panel (identical to login) */}
...
const s: Record<string, React.CSSProperties> = {
  ...
  logoRow:{ display:"flex", alignItems:"center", justifyContent:"center", gap:"16px", marginBottom:"36px" },
  ...
  btnMain:{ width:"100%", padding:"13px", background:"linear-gradient(135deg,#1565c0 0%,#1e88e5 100%)", border:"none", borderRadius:"10px", fontSize:"0.95rem", fontWeight:700, letterSpacing:"0.06em", color:"white", cursor:"pointer", transition:"all .25s", boxShadow:"0 4px 15px rgba(21,101,192,.35)", fontFamily:"'Rajdhani',sans-serif" },
