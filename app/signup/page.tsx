...
import { apiRegister, saveToken, saveUser, loginWithGoogle, loginWithFacebook, loginWithLinkedIn } from "@/lib/api";
    ...
    <>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .gos-field { display: flex; flex-direction: column; gap: 5px; flex: 1; }
        .gos-lbl {
        ...
        <div className="gos-right">
          <div className="gos-box">
            ...
            <div className="gos-tabs">
              <Link href="/login" className="gos-tab">Sign In</Link>
            ...
            <p className="gos-switch">
              ...
              <Link href="/login" className="gos-switch-link">Sign in →</Link>
            </p>
